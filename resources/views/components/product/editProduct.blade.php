@push('styles')
    <link rel="stylesheet" href="{{ asset('css/gstore/editProduct.css') }}">
@endpush
@extends('layouts.app')
        ...
        <div class="card mb-4">
            <div class="d-flex flex-row">
                <div class="card-body d-flex flex-column justify-content-center">
                    <form method="POST" action="{{url('/products/edit/'.Crypt::encrypt($product->id))}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div>
                                    ...
                                    <Input @error('stock') is-invalid @enderror name="stock"  autofocus class="range" type="range" name="stock" value="{{ $product->stock}}" min="1" max="10000" onChange="rangeSlideStock(this.value)" onmousemove="rangeSlideStock(this.value)"></Input>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div>
                                    <p class="text-warning ">*use arrow button to be precise</p>
                                    <Input @error('price') is-invalid @enderror name="price"  autofocus class="range" type="range" name="price" value="{{ $product->price}}" min="5000" max="999999" step="500" onChange="rangeSlidePrice(this.value)" onmousemove="rangeSlidePrice(this.value)"></Input>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" type="text" class="form-control @error('description') is-invalid @enderror" name="description" autocomplete="description" autofocus>{{ $product->description}}</textarea>
                                @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <img src="{{asset('storage/products/'.$product->picture)}}" alt="" class="img-thumbnail">
